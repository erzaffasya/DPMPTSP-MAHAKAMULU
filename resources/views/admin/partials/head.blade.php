...
<title>Dashboard | DPMPTSP Mahakam</title>
...
<link rel="stylesheet" href="{{ asset('tadmin/assets/vendor/fonts/boxicons.css') }}" />

<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('tadmin/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
<link rel="stylesheet" href="{{ asset('tadmin/assets/vendor/css/theme-default.css') }}"
