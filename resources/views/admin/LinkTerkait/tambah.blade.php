<x-app-layout>
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('LinkTerkait.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-default-fullname" placeholder="https://example.com" name="link">
                </div>
