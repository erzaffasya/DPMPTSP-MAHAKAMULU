        ...
        <div class="card-body">
            <form action="{{ route('KategoriBerita.update',$KategoriBerita->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-default-fullname" name="nama_kategori" value="{{$KategoriBerita->nama_kategori}}">
                </div>

                <div class="mb-3">
                    <label class="form-label" for="basic-default-message">Deskripsi</label>
                    <textarea id="basic-default-message" class="form-control" name="deskripsi" >{{$KategoriBerita->deskripsi}}</textarea>
                </div>
