        ...
        <div class="card-body">
            <form action="{{ route('Pelayanan.update', $Pelayanan->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-default-fullname" value="{{$Pelayanan->judul}}" name="judul">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="{{$Pelayanan->deskripsi}}" id="basic-default-fullname"
                        placeholder="https://example.com" name="deskripsi">
                </div>
